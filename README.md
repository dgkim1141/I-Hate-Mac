...
## VSCode
### 프로젝트의 C++ Intelisense가 먹통일 때 

참조 영상 : https://www.youtube.com/watch?v=yAUgFZh28aA
...
```
            "defines": [
                ...
                "**<<<MYPROJECT>>>**_VTABLE=DLLEXPORT_VTABLE",
                "**<<<MYPROJECT>>>**_API="
            ],
            
            MYPROJECT, MyProject 둘 다 프로젝트 명으로 바꿀것.
            전자는 대문자임.
```


4. 적당한 헤더나 cpp파일에서 #include 쪽에 커서를 대서 대충 인텔리센스를 다시 로딩한다.
5. 조금 기다리고 나면 인텔리센스가 정상화된다.
